...
#define MAX_READ_TIMEOUT 20
#define MAX_STUCK_TIMEOUT 20  
...
void loop()
{
  ...
  {   
    ...
    String data = "http://iotapi.aronasoft.com/helpers/functions.php?type=arduinoApi&count=1&temp="+temperatureString+"&humidity="+humidityString;
